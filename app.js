(() => {
  ...
  function setupDragTabs() {
    ...
    // Phones and tablets use native momentum scrolling. Custom dragging is
    // restricted to mouse/trackpad-style pointers so touch remains smooth.
    ...
    scroller.addEventListener("pointermove", event => {
      ...
      if (!didDrag && Math.abs(delta) < 6) return;
      didDrag = true;
