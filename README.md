...
Fixed the startup JavaScript error that prevented themes, tabs, effects, calendar loading, and Easter eggs from initializing. Updated the Club Matches links to the Chess.com club events page.


## v1.0.6 League Registration

- Added a dedicated **League Registration** page.
- Embedded the official Tally form:
  `https://tally.so/r/xXLV8o`
- Added an **Open Full Form** fallback button.
- Added League Registration to the page tabs, Home quick links, and Links page.
